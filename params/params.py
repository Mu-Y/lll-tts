...
class Params:
    ...
    **************** PARAMETERS OF TRAINING LOOP ****************
    ...
    learning_rate_decay_start = 15000    # number of training steps until the first lr decay, expected to be greater than learning_rate_decay_each  (do not need it any more)
    learning_rate_decay_each = 80     # size of the learning rate scheduler step in training steps, it decays lr every this number steps (unit: epochs)
