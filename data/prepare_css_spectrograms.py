...
if __name__ == '__main__':
    ...
    files_to_solve = [
        (args.css10_directory, "train_german.txt"),
        (args.css10_directory, "val_german.txt"),
        (args.css10_directory, "test_german.txt"),
        (args.css10_directory, "train_dutch.txt"),
        (args.css10_directory, "val_dutch.txt"),
        (args.css10_directory, "test_dutch.txt"),
        (args.css10_directory, "train_chinese.txt"),
        (args.css10_directory, "val_chinese.txt"),
        (args.css10_directory, "test_chinese.txt"),
        (args.css10_directory, "train_japanese.txt"),
        (args.css10_directory, "val_japanese.txt"),
        (args.css10_directory, "test_japanese.txt"),
    ]
