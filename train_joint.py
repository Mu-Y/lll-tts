...
if __name__ == '__main__':
    ...
    train_data = DataLoader(dataset.train, batch_size=hp.batch_size, drop_last=True, shuffle=True,
                            sampler=None, collate_fn=TextToSpeechCollate(True), num_workers=args.loader_workers)
    ...
    if args.checkpoint:
        ...
        print("model loaded from {}".format(os.path.join(args.save_dir, args.checkpoint_root, args.checkpoint)))
